...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Credits are consumed based on the complexity of operations. Simple encoding uses 5 credit, while complex conversions may use 10-50 credits per operation.",
  },
  {
