...
export default function Maintenance() {
  ...
  const [phases] = useState(maintenancePhases);
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-6xl">
          ...
          <div className="text-center mb-6">
            ...
            <div className="bg-slate-800/30 rounded-lg p-6 font-mono">
              <div className="text-sm text-gray-400 mb-2">
                {isEncoding
                  ? "Encoding: MAINTENANCE → Base64"
                  : "Decoding: Base64 → MAINTENANCE"}
              </div>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href="mailto:emergency@fileforge.com"
        ...
        >
          <p className="text-gray-400 text-sm">
            Thank you for your patience while we improve FileForge
          </p>
