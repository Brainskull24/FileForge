              ...
              <TabsContent key={plan} value={plan}>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {plan === "free" &&
                        "Community-driven support with self-service resources"}
                      {plan === "pro" &&
                        "Priority support with multiple channels"}
                      {plan === "enterprise" &&
        ...
        <section>
          <Card className="max-w-4xl mx-auto">
            <CardHeader>
              ...
              <CardDescription>
                Help us improve FileForge by sharing your ideas and feedback
              </CardDescription>
            </CardHeader>
            <CardContent>
