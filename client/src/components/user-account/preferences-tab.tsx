    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure your default processing preferences
          </CardDescription>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handlePreferenceChange("encodingFormat", value)
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handlePreferenceChange("quality", value)
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handlePreferenceChange("autoDelete", value)
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handlePreferenceChange("downloadFormat", value)
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handlePreferenceChange("batchDefaults", value)
                }
              >
                <SelectTrigger>
                  <SelectValue />
                ...
                <SelectContent>
                  <SelectItem value="low">
                    Low Priority (Slower, Less Resources)
                  </SelectItem>
                  <SelectItem value="medium">Medium Priority</SelectItem>
                  <SelectItem value="high">
                    High Priority (Faster, More Resources)
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Customize your application interface
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  handlePreferenceChange("sidebarCollapsed", checked)
                }
              />
            </div>
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Display thumbnail previews of files
                </p>
              </div>
              <Switch
