...
import { Key, Plus, Copy, Trash2, BarChart3, Book, Code, Download } from "lucide-react"
            ...
            <TableBody>
              {apiKeys.map((apiKey) => (
                <TableRow key={apiKey.id}>
                  ...
                  <TableCell>
                    <Badge variant={apiKey.status === "Active" ? "secondary" : "outline"}>{apiKey.status}</Badge>
                  </TableCell>
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Button variant="outline" size="sm">
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                ...
                <DialogDescription>Configure your new API key with specific permissions and settings</DialogDescription>
              </DialogHeader>
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setNewKeyData((prev) => ({ ...prev, rateLimit: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewKeyData((prev) => ({ ...prev, expiration: e.target.value }))}
                  />
                </div>
              </div>
              <DialogFooter>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Button variant="outline" className="h-auto p-4 flex flex-col items-start gap-2 bg-transparent">
              ...
              <p className="text-sm text-muted-foreground text-left">Get started with our API in minutes</p>
            </Button>
            <Button variant="outline" className="h-auto p-4 flex flex-col items-start gap-2 bg-transparent">
              <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground text-left">Complete documentation of all endpoints</p>
            </Button>
            <Button variant="outline" className="h-auto p-4 flex flex-col items-start gap-2 bg-transparent">
              <div className="flex items-center gap-2">
                <Code className="h-4 w-4" />
              ...
              <p className="text-sm text-muted-foreground text-left">Sample code in multiple languages</p>
            </Button>
            <Button variant="outline" className="h-auto p-4 flex flex-col items-start gap-2 bg-transparent">
              <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground text-left">Official SDKs for popular languages</p>
            </Button>
          </div>
        </CardContent>
      </Card>
