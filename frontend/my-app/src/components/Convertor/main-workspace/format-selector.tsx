...
export function FormatSelector({ selectedTool, currentTool, selectedFormat, setSelectedFormat }: FormatSelectorProps) {
  return (
    <Card>
      <CardHeader>
          ...
          {selectedTool === "pdf-conversion" && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 md:grid-cols-5 gap-2">
                  {currentTool.formats.fromPdf?.map((format: string) => (
                    <Button
                      key={format}
          ...
          {selectedTool === "word-conversion" && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 md:grid-cols-5 gap-2">
                  {currentTool.formats.fromWord?.map((format: string) => (
                    <Button
                      key={format}
          ...
          {selectedTool === "excel-conversion" && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 md:grid-cols-5 gap-2">
                  {currentTool.formats.fromExcel?.map((format: string) => (
                    <Button
                      key={format}
