      ...
      <div className="border-b bg-muted/30">
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">Your data security and privacy are our top priorities</p>
          ...
          <section className="mb-16">
            <Card className="border-2 border-primary/20">
              <CardHeader className="text-center">
                ...
                <CardDescription>Enterprise-grade security measures protecting your data</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="text-center p-4">
                    ...
                    <p className="text-sm text-muted-foreground">for all data</p>
                  </div>
                  <div className="text-center p-4">
                ...
                <CardContent>
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="end-to-end">
                      <AccordionTrigger>End-to-End Encryption (Enterprise)</AccordionTrigger>
                      <AccordionContent>
                        <ul className="space-y-2 text-sm">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <h4 className="font-semibold mb-3 text-green-600">What We Collect</h4>
                      <ul className="space-y-2 text-sm">
                    ...
                    <div>
                      <h4 className="font-semibold mb-3 text-red-600">What We Don't Collect</h4>
                      <ul className="space-y-2 text-sm">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="text-center p-4 border rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground mb-3">Download all your data</p>
                    ...
                    <div className="text-center p-4 border rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground mb-3">Delete account and all data</p>
                      <Button size="sm" variant="outline">
                        Delete Account
                      </Button>
                    </div>
                    <div className="text-center p-4 border rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground mb-3">Transfer to other services</p>
                      <Button size="sm" variant="outline">
                        Transfer Data
                      </Button>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      {["7", "30", "90", "365"].map((days) => (
                        <Button
                          key={days}
                          variant={retentionPeriod === days ? "default" : "outline"}
                          size="sm"
                ...
                <CardContent>
                  <Accordion type="single" collapsible>
                    ...
                    <AccordionItem value="authorization">
                      <AccordionTrigger>Role-Based Access Control</AccordionTrigger>
                      <AccordionContent>
                        <ul className="space-y-2 text-sm">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        General Data Protection Regulation compliance with EU data protection standards
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-semibold mb-2">CCPA</h4>
                      <p className="text-sm text-muted-foreground">
                        California Consumer Privacy Act compliance with consumer privacy rights
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Information security management with continuous monitoring
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                      <h4 className="font-semibold mb-3">Data Breach Protocol</h4>
                      <ul className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Report security issues and vulnerabilities</p>
                        <a href="mailto:security@fileforge.com" className="text-sm text-primary hover:underline">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">GDPR/CCPA requests and privacy concerns</p>
                        <a href="mailto:privacy@fileforge.com" className="text-sm text-primary hover:underline">
