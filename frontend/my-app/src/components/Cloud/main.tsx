...
export default function CloudIntegrationPage() {
  const [connectedServices,] = useState([
    { id: "gdrive", name: "Google Drive", email: "user@company.com", connected: true, lastSync: "2 minutes ago" },
    { id: "dropbox", name: "Dropbox", email: "user@company.com", connected: true, lastSync: "1 hour ago" },
    { id: "onedrive", name: "OneDrive", email: "user@company.com", connected: false, lastSync: "Never" },
  ])
  ...
  const integrationServices = [
    ...
    },
    {
      ...
      logo: "🔷",
      connected: true,
      features: ["Team folder access", "File versioning", "Collaborative processing", "Webhook notifications"],
    ...
    },
    {
      ...
      logo: "🔶",
      connected: false,
      features: ["SharePoint integration", "Office 365 compatibility", "Enterprise security", "Bulk operations"],
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground text-lg">
            Connect your favorite cloud storage services for seamless file management
          </p>
        </div>
              ...
              {integrationServices.map((service) => (
                <Card key={service.id} className="relative">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button className="w-full" variant={service.connected ? "outline" : "default"}>
                      {service.connected ? (
                        <>
          ...
          <TabsContent value="setup" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Follow these steps to connect your cloud storage service</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                    ...
                    <div key={step} className="flex items-center">
                      <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center ${
                          setupStep >= step ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"
                        }`}
                      >
                        {step}
                      </div>
                      {step < 3 && <div className={`w-20 h-0.5 ${setupStep > step ? "bg-primary" : "bg-muted"}`} />}
                    </div>
                  ))}
                </div>
                ...
                {setupStep === 1 && (
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium">Step 1: Service Selection</h3>
                      ...
                      {integrationServices.map((service) => (
                        ...
                        >
                          <CardContent className="p-4 text-center">
                            <span className="text-3xl mb-2 block">{service.logo}</span>
                    ...
                    <Button onClick={() => setSetupStep(2)} disabled={!selectedService} className="w-full">
                      Continue with{" "}
                      {selectedService ? integrationServices.find((s) => s.id === selectedService)?.name : "Service"}
                ...
                {setupStep === 2 && (
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium">Step 2: OAuth Authorization</h3>
                    <Alert>
                      <Shield className="h-4 w-4" />
                      <AlertDescription>
                        You will be redirected to authorize the following permissions:
                      </AlertDescription>
                    </Alert>
                    <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button onClick={() => setSetupStep(3)} className="flex-1">
                ...
                {setupStep === 3 && (
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium">Step 3: Configuration</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="auto-cleanup">Enable automatic cleanup of processed files</Label>
                    </div>
                    <div className="flex gap-2">
                      ...
                      <TableRow key={service.id}>
                        <TableCell className="flex items-center gap-2">
                          <span className="text-lg">
                            {service.name === "Google Drive" ? "🔵" : service.name === "Dropbox" ? "🔷" : "🔶"}
                          </span>
                          {service.name}
                        </TableCell>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Configure global synchronization preferences</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Configure folder assignments for file operations</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Cloud-triggered automation workflows</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  {workflows.map((workflow, index) => (
                    <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                      <div className="space-y-1">
                        ...
                        <div className="text-sm text-muted-foreground">{workflow.triggers} triggers this month</div>
                      </div>
                      <div className="flex items-center gap-2">
                  ...
                  <div className="space-y-3">
                    <div className="p-3 border rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-medium">Auto-convert uploaded PDFs</span>
                      </div>
                      <p className="text-sm text-muted-foreground mb-3">
                        Automatically convert PDF files to text when uploaded to specified folders
                      </p>
                    ...
                    <div className="p-3 border rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-medium">Batch process images in folder</span>
                      </div>
                      <p className="text-sm text-muted-foreground mb-3">
                        Resize and optimize images automatically when added to watched folders
                      </p>
                      <Button size="sm" variant="outline" className="w-full bg-transparent">
                        Use Template
                      </Button>
                    ...
                    <div className="p-3 border rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-medium">Encode sensitive documents</span>
                      </div>
                      <p className="text-sm text-muted-foreground mb-3">
                        Automatically encrypt and secure sensitive files upon upload
                      </p>
                      <Button size="sm" variant="outline" className="w-full bg-transparent">
                        Use Template
                      </Button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Review and manage granted permissions</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">File encryption in transit</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Shield className="w-4 h-4 text-green-500" />
                      <span className="text-sm">Secure temporary file handling</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Shield className="w-4 h-4 text-green-500" />
                      <span className="text-sm">30-day data retention policy</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Shield className="w-4 h-4 text-green-500" />
          ...
          <TabsContent value="analytics" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>File processing breakdown by cloud service</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">Google Drive</span>
                    <span className="text-sm text-muted-foreground">1,247 files (58%)</span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">892 files (42%)</span>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">0 files (0%)</span>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label>Events</Label>
                    <div className="space-y-2">
                      {["File uploaded", "File modified", "File deleted", "Folder changes"].map((event) => (
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Diagnostic tools and common issues</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-3">
